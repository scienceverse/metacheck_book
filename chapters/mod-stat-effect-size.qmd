...
title: "Effect Sizes"
vignette: >
  %\VignetteIndexEntry{Effect Sizes}
...
## A real example of an incorrect effect size

The `no_match` verdict catches genuine mistakes. The *Psychological Science* article "Going All In: Unfavorable Sex Ratios Attenuate Choice Diversification" (DOI [10.1177/0956797616636631](https://doi.org/10.1177/0956797616636631)) reports, in a single sentence, two main effects:
