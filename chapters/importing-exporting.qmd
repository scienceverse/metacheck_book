...
```{r, include = FALSE}
# tidy up the HTML files generated by this chapter's examples
unlink(c("example-jasp-output.html", "example-omv-output.html",
        "example-spv-output.html", "example-chart-output.html"))
```
