...
- [Data Validate](mod-data-validate.qmd) runs automated data-quality checks on the columns `data_check` extracts, including spreadsheet-formatting checks (colour coding, merged cells, empty rows/columns) for `.xlsx`/`.xls`/`.ods`/`.fods` files.
