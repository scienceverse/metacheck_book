...
| **yellow** | fewer than a quarter of columns were flagged (or only careless-responding respondents were flagged) |
...
| `$report` | formatted report with the issue breakdown, out-of-range table, combined distribution figure, demographic inventory, Qualtrics summary, and careless-responding table |

## Related

- [Data Check](mod-data-check.qmd) is run first and supplies the columns, facets, and read data frames.
